...
function eiCompare(a, b) {
    ...
    if (!a.completed && !b.completed && a.home_win_probability === undefined && b.home_win_probability !== undefined) return -1;
    if (!a.completed && !b.completed && b.home_win_probability === undefined && a.home_win_probability !== undefined) return 1;
